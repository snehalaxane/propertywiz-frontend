...
//       <div className="relative bg-blue-700 text-white py-20 md:py-32 overflow-hidden">
//         {/* Background Image Overlay */}
//         {/* Placeholder for a professional, inviting contact image */}
...
//             We are here to help! Send us a message, or connect with us through the details below.
//           </p>
//         </div>
//       </div>

//       {/* Main Content Area */}
//       <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 py-16 px-6 md:px-12">
//         {/* Left Column: Contact Information */}
//         <div className="bg-white p-10 rounded-xl shadow-xl flex flex-col justify-center">
//           <h2 className="text-3xl font-bold text-gray-900 mb-6">Reach Out to Us</h2>
//           <p className="text-gray-600 mb-8 leading-relaxed">
//             Have questions, need a quote, or just want to say hello? Our team is ready to assist you.
//             Fill out the form or use the contact details provided.
//           </p>

//           <div className="space-y-6 mb-8">
//             <div className="flex items-center text-gray-700">
//               <FaPhone className="text-blue-600 text-2xl mr-4 flex-shrink-0" />
//               <div>
...
//               <FaMapMarkerAlt className="text-blue-600 text-2xl mr-4 flex-shrink-0 mt-1" />
//               <div>
...
//             <button
//               type="submit"
//               className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg text-lg font-semibold hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 transition duration-300 ease-in-out transform hover:-translate-y-0.5"
//             >
//               Send Message
//             </button>
//           </form>
...
//         <h2 className="text-3xl font-bold text-gray-900 text-center mb-8">Find Us on the Map</h2>
//         <div className="bg-white rounded-xl shadow-xl overflow-hidden">
//           {/* Replace with your actual Google Maps embed iframe or a static map image */}
//           <iframe
