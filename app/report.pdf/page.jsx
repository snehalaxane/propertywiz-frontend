...
// import { FaFileDownload } from 'react-icons/fa'; // For the download icon
...
//             Download Your <span className="text-blue-600">Verification Report</span>
//           </h2>
//           <p className="text-lg text-gray-600">
//             Enter your details to instantly download a sample Due Diligence Report.
//             Gain insights into our thorough verification process.
//           </p>
//         </div>

//         {/* Form Container - Enhanced Look */}
...
//                   autoComplete="name"
//                   required
//                   className="appearance-none relative block w-full px-4 py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 
//                              focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 text-base transition duration-200"
...
//               <button
//                 type="submit"
//                 className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-lg font-semibold rounded-lg text-white bg-blue-600 
//                            hover:bg-blue-700 focus:outline-none focus:ring-3 focus:ring-offset-2 focus:ring-blue-500 transition duration-300 ease-in-out transform hover:scale-[1.01]"
//               >
//                 <span className="absolute left-0 inset-y-0 flex items-center pl-3">
//                   <FaFileDownload className="h-5 w-5 text-blue-100 group-hover:text-white" aria-hidden="true" />
//                 </span>
//                 Download Report
//               </button>
//             </div>
...
//           {/* Left Column: Report Showcase (Dark/Contrast) */}
...
// // Helper component for styled form groups
