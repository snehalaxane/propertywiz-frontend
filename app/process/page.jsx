...
// // Reusable Component for a single step in the timeline
// function ProcessStep({ step, isLast }) {
//   return (
//     <div className="flex relative">
//       {/* Vertical Line and Connector Dot */}
...
//       {/* Content Card */}
//       <div className={`bg-white rounded-xl p-6 mb-8 shadow-lg hover:shadow-xl transition duration-300 w-full`}>
