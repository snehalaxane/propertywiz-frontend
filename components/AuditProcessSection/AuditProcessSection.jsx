...
//         <motion.p
//           className="text-s text-gray-600 max-w-2xl mx-auto mb-12"
//           initial={{ opacity: 0, y: 20 }}
//           whileInView={{ opacity: 1, y: 0 }}
//           viewport={{ once: true }}
...
//               {icon}
//             </div>
//              <div className="ml-4 w-10 h-10 flex items-center justify-center rounded-full bg-blue-600 text-white text-xl font-bold flex-shrink-0">
//                 {index + 1}
//               </div>
//           </div>
...
//       {!isLast && (
//         <div className="hidden md:block absolute top-1/3 left-[100%] w-[50%] -translate-x-1/2 -translate-y-1/2 pointer-events-none">
//           {/* Subtle Right Arrow/Line */}
//           <svg className="w-full h-2 text-blue-400" fill="none" viewBox="0 0 100 2">
//             <line x1="0" y1="1" x2="100" y2="1" stroke="currentColor" strokeDasharray="3 3" strokeWidth="1" />
//             <polygon points="100,0 95,1 100,2" fill="currentColor" />
//           </svg>
//         </div>
//       )}
//     </motion.div>
...
// export default function AuditProcessSection() {
//   return (
//     <section className="w-full py-20 px-4 md:px-6 bg-white font-inter">
//       <div className="max-w-7xl mx-auto">
        
//         {/* Heading */}
//         <div className="text-center mb-16">
//           <motion.h2
//             className="text-base font-semibold text-blue-500 tracking-wider uppercase mb-2"
//             initial={{ opacity: 0 }}
...
//           </motion.h2>
//           <motion.h1
//             className="text-4xl md:text-4xl font-bold text-black tracking-tight"
//             initial={{ opacity: 0, y: 20 }}
//             whileInView={{ opacity: 1, y: 0 }}
//             viewport={{ once: true }}
//             transition={{ duration: 0.6, delay: 0.1 }}
//           >
//             A Simple, Transparent Verification Process
//           </motion.h1>
...
//         {/* Steps Grid (Desktop) */}
//         <div className="hidden md:grid md:grid-cols-3 gap-x-12 relative">
